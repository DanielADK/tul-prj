...
\begin{table}[H]
    ...
    \multicolumn{1}{|l|}{Integrace přijímacího řízení}  & \multicolumn{1}{c|}{{\color[HTML]{009901} \CheckmarkBold}}          & \multicolumn{1}{c|}{{\color[HTML]{009901} \CheckmarkBold}} & \multicolumn{1}{c|}{{\color[HTML]{CB0000} \XSolid}}                               & \multicolumn{1}{c|}{{\color[HTML]{CB0000} \XSolid}} \\ \hline
    \multicolumn{1}{|l|}{Integrace spisových služeb}    & \multicolumn{1}{c|}{{\color[HTML]{CB0000} \XSolid}}          & \multicolumn{1}{c|}{{\color[HTML]{009901} \CheckmarkBold}} & \multicolumn{1}{c|}{{\color[HTML]{CB0000} \XSolid}}                               & \multicolumn{1}{c|}{{\color[HTML]{CB0000} \XSolid}} \\ \hline
    ...
    \multicolumn{1}{|l|}{Digitální evidence SPU}        & \multicolumn{1}{c|}{{\color[HTML]{009901} \CheckmarkBold}}          & \multicolumn{1}{c|}{{\color[HTML]{009901} \CheckmarkBold}} & \multicolumn{1}{c|}{{\color[HTML]{009901} \CheckmarkBold}}                                        & \multicolumn{1}{c|}{{\color[HTML]{009901} \CheckmarkBold}}          \\ \hline
...
každá přidružená k některé z kategorií funkcionalit, které IS disponuje.
Tabulka 
...
\begin{table}[H]
    ...
    \multicolumn{1}{c}{\textbf{Druh nákladu}}                                                & \textbf{\begin{tabular}[c]{@{}c@{}}Personál \\ {[}osoba{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Doba \\ {[}h{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Člověko-\\ hodiny\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Cena\\ práce\\ {[}Kč/hod{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Skutečná \\ cena {[}Kč{]}\end{tabular}} \\ \hline
    \textbf{Migrace dat}                                                                     & 3                                                                        & 40                                                               & 120                                                                & 500.45 {[}1{]}                                                               & 60054.00                                                                   \\
    \textbf{\begin{tabular}[c]{@{}l@{}}Rekonfigurace školních \\ subsystémů\end{tabular}}                                                  & 5                                                                        & 40                                                               & 200                                                                & 292.76 {[}2{]}                                                               & 58552.00                                                                   \\
    \textbf{Školení pedagogů}                                                                & 72                                                                       & 8                                                                & 576                                                                & 292.76 {[}2{]}                                                               & 168629.76                                                                  \\
    \textbf{\begin{tabular}[c]{@{}l@{}}Školení specializovaných \\ zaměstnanců\end{tabular}} & 34                                                                       & 8                                                                & 272                                                                & 292.76 {[}2{]}                                                               & 79630.72                                                                   \\
    \textbf{Školení vedení školy}                                                            & 6                                                                        & 8                                                                & 48                                                                 & 292.76 {[}2{]}                                                               & 14052.48                                                                   \\ \hline
    \textbf{SOUČET}                                                                          & 117                                                                      & 80                                                               & 1928                                                               & \multicolumn{1}{l}{}                                                         & \multicolumn{1}{l}{380918.96}                                             
    \end{tabular}
\end{table}

\begin{table}[]
    \begin{tabular}{lcccc}
    \multicolumn{1}{c}{\textbf{Druh nákladu}}                                                & \textbf{\begin{tabular}[c]{@{}c@{}}Personál \\ {[}osoba{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Doba \\ {[}h{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Cena\\ práce\\ {[}Kč/hod{]}\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Skutečná \\ cena {[}Kč{]}\end{tabular}} \\ \hline
    \textbf{Migrace dat}                                                                     & 3                                                                        & 40                                                               & 445.09 {[}1{]}                                                               & 53410.8                                                                    \\
    \textbf{Rekonfigurace školních systémů}                                                  & 5                                                                        & 40                                                               & 292.76 {[}2{]}                                                               & 58552.00                                                                   \\
    \textbf{Školení pedagogů}                                                                & 72                                                                       & 8                                                                & 292.76 {[}2{]}                                                               & 168629.76                                                                  \\
    \textbf{\begin{tabular}[c]{@{}l@{}}Školení specializovaných \\ zaměstnanců\end{tabular}} & 29                                                                       & 8                                                                & 292.76 {[}2{]}                                                               & 67920.32                                                                   \\
...
skládají z třídních učitelů (22), metodiků prevence (1), výchovných poradců (2), 
koordinátoři ICT (2), koordinátorů ŠVP (1), správci sítě (1) o celkovém počtu 29.
Počet členů vedení školy je 6, tedy ředitel, 3x zástupce ředitele a 2x výchovné poradkyně.
