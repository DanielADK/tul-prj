...
Ředitel školy zastává názor, že veřejné API je velká bezpečnostní hrozba díky možném útokům
...
vyžadované datasety. Nejdůležitější funkcionalitou je export dat pro Ministerstvo školství, mládeže 
...
druhu číselníku, typu dat, délce povoleného řetězce a povinnost záznamu. Uvedu výčet několika položek:
\begin{itemize}
    \item datum sběru,
    \item IZO školy,
...
číselníků\cite{msmt-rozhrani-predavani-dat-2023}. Možnost implementace se ještě zhoršuje díky formátu,
